...
catalog-check:
	@jq -e 'length == 873 and ([.[].imagePaths | length] | add) == 1746 and all(.[]; has("name") and has("unit") and has("instructions") and (.imagePaths | length == 2))' StrengthLog/Resources/exercise-catalog.json >/dev/null
